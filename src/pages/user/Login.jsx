...
export default function Login() {
  ...
  return (
    <div className=" p-4 w-full md:flex flex-row-reverse gap-8 justify-center items-center rounded-md bg-white h-screen">
      <div className="shadow-md p-4">
        <h2 className="text-center text-[1.5rem] font-semibold pb-4">Login</h2>
